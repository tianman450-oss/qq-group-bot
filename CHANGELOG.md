...
- NoneBot2 + OneBot V11 based QQ group bot runtime
- LLM chat with roleplay, memory, web search, summary, and vision support
- ComfyUI text-to-image and image-to-image workflows
- Per-user model and LoRA selection
